...
*v1.0 起草：2026-05-15 02:30 CST F session*
*起草前置：Codex 调研 5 反转 + Dan 拍立即修 Vercel 配置 + 仅修 Minimax 大小写*
*下一动作：Codex T-B10-010 verify Vercel CLI 能力 → 串行实施 → PR + squash merge（不 --prod）*
