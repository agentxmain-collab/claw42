...
export const dispatchTopics: DispatchTopic[] = [
  {
    ...
    strategy: {
      ...
      name: "本次决策",
      ticker: "$BTC",
      meta: "3 个阶段已完成 · 交易策略总监正在出方案 · 预计 1-2 分钟",
      entry: "待定",
      stopLoss: "待定",
      takeProfit: "待定",
      follow: {
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        ...
        time: "18:38",
        mentions: [],
        content: "已落盘 #s-4205。同标的 SHORT 30 日胜率 **58%**。经验已注入下一轮工作流。",
      },
    ],
    strategy: {
      action: "short",
