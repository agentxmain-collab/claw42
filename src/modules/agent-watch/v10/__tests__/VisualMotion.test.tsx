...
describe("DispatchConsoleV10 visual motion", () => {
  ...
  test("pins the expanded realtime summary footer without clipping the scroll content", () => {
    ...
    expect(activeSummary).toContain("right: 0");
    expect(activeSummary).toContain("bottom: -1px");
    expect(activeSummary).toContain("left: 0");
    expect(activeSummary).toContain("padding: 12px 22px 0");
    expect(activeSummary).toContain("background:");
