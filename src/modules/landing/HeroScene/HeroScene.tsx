        ...
        <div className="claw42-hero-actions pointer-events-auto flex flex-col items-center justify-center gap-4 sm:flex-row">
          <div className="relative">
            <motion.button
              ...
              className="inline-flex min-w-[9.25rem] items-center justify-center rounded-xl bg-brand-purple-bright px-6 py-2.5 text-sm font-semibold text-white transition-all hover:bg-brand-purple md:text-base"
            >
              {t.hero.ctaPrimary}
            </motion.button>
            <AnimatePresence>
