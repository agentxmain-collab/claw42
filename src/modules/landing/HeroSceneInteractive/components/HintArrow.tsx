...
export function HintArrow({ text, reduceMotion }: HintArrowProps) {
  return (
    ...
    >
      <span className="border-[#62f0ff]/28 bg-black/64 rounded-full border px-3 py-1 text-xs font-semibold text-white shadow-lg">
        {text}
      </span>
      <svg
        className="mt-2 h-10 w-10 text-[#62f0ff]"
        viewBox="0 0 40 40"
        fill="none"
        aria-hidden="true"
      >
