...
export const FACTION_REGISTRY: Record<AgentId, FactionProfile> = {
  alpha: {
    ...
    avatarBase: withBasePath("/images/agents/alpha-120.png"),
    ipDocFile: "老K.md",
    catchphrases: [
      "破位才是真信号，盘整就是装死",
      "不破不立，不立不破",
  ...
  beta: {
    ...
    avatarBase: withBasePath("/images/agents/beta-120.png"),
    ipDocFile: "老白.md",
  ...
  gamma: {
    ...
    avatarBase: withBasePath("/images/agents/gamma-120.png"),
    ipDocFile: "老G.md",
