...
- ❌ "EMA12/13 共振" → ✅ "短期线在 <PRICE_FAST> / 中期线在 <PRICE_SLOW>，两条线在 <PRICE> 附近合上"
- ❌ "<SYMBOL> 突破前高" → ✅ "$<SYMBOL> 现价 <PRICE>，比上周高点 <HIGH> 高 <DELTA>"
- ❌ "等 5min K 线确认" → ✅ "再看 5 分钟，如果价格稳在 <PRICE> 上方，就算确认"
- ❌ "极端涨速" → ✅ "30 分钟从 <LOW> 拉到 <HIGH>，涨了 <PCT>%，太快可能回吐"
- ❌ "趋势没破" → ✅ "$<SYMBOL> 从昨晚到现在一直在 <PRICE> 上方，这条线没破就是涨势"
